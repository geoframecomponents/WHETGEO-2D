 ...
 *
 */
public class HydrostaticDistribution {

	@In
	public List<Double[]> elementsCentroidsCoordinates;
	
	@In
	public double waterSuctionAtBottom;
	...
	public void process() {
		...
		for(int element=1; element<elementsCentroidsCoordinates.size(); element++) {
			...
			initialCondition.set(element, waterSuctionAtBottom-elementsCentroidsCoordinates.get(element)[1]);
